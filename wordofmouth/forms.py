...
class RecipeForm(forms.Form):
    ...
    ingredients = forms.CharField(label='Enter Ingredients and Specified Amounts (please separate ingredients by clicking \'Enter\')',widget=forms.Textarea(attrs={"rows":5, "cols":20}))
    directions = forms.CharField(label='Enter Directions (please separate directions by clicking \'Enter\')',widget=forms.Textarea(attrs={"rows":5, "cols":20}))
